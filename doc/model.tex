...
\begin{description}
    ...
    \end{description}
    \item[pos]: Molecular study looked only at promoter region.
    \begin{description}
        \item[pos0]: This can only happen if the genotype is gen00, gen01 or gen11.
        \item[negab]: The complement of pos0.
    \end{description}
\end{description}
